export default {
  ...
  suppressFailureAlerts: 'Suppress failure notifications',
  slackNotifications: 'Slack Notifications',
  newSlackNotification: 'New Slack Notification',
  editSlackNotification: 'Edit Slack Notification',
  deleteSlackNotification: 'Delete Slack Notification',
  deleteSlackNotificationMsg: 'Are you sure you want to delete this Slack notification?',
  slackToken: 'Token',
  slackChannel: 'Destination Channels',
  slackColor: 'Notification Color',
  slackStartedMessage: 'Customize Started Message',
  slackSuccessMessage: 'Customize Success Message',
  slackErrorMessage: 'Customize Error Message',
  slackNotificationStarted: 'Slack Notification (Started)',
  slackNotificationSuccess: 'Slack Notification (Success)',
  slackNotificationFailure: 'Slack Notification (Failure)',
