export default {
  ...
  suppressFailureAlerts: '失敗アラートを抑制',
  slackNotifications: 'Slack通知',
  newSlackNotification: 'Slack通知を作成',
  editSlackNotification: 'Slack通知を編集',
  deleteSlackNotification: 'Slack通知を削除',
  deleteSlackNotificationMsg: 'このSlack通知を削除しますか？',
  slackToken: 'トークン',
  slackChannel: '送信先チャンネル',
  slackColor: '通知カラー',
  slackStartedMessage: '開始メッセージ（カスタム）',
  slackSuccessMessage: '成功メッセージ（カスタム）',
  slackErrorMessage: '失敗メッセージ（カスタム）',
  slackNotificationStarted: 'Slack通知（開始）',
  slackNotificationSuccess: 'Slack通知（成功）',
  slackNotificationFailure: 'Slack通知（失敗）',
